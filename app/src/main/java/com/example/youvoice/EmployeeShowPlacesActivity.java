...
public class EmployeeShowPlacesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_show_places);
    ...
    class LoadAllPlaces extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeShowPlacesActivity.this);
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(EmployeeShowPlacesActivity.this, message, Toast.LENGTH_LONG).show();

            // make list adapter to fill the place list
            ListAdapter adapter = new SimpleAdapter(EmployeeShowPlacesActivity.this,
            ...
            place_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent place_menu = new Intent(EmployeeShowPlacesActivity.this, EmployeeShowPlaceMenuActivity.class);
    ...
    public void onBackPressed() {
        Intent in = new Intent(EmployeeShowPlacesActivity.this, EmployeeMenuActivity.class);
        startActivity(in);
    }
}