...
public class UserShowPlaceEvaluationsActivity extends Activity {
    ...
    class LoadAllEvaluations extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UserShowPlaceEvaluationsActivity.this);
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(UserShowPlaceEvaluationsActivity.this, message, Toast.LENGTH_LONG).show();

            // make list adapter to fill the evaluation list
            ListAdapter adapter = new SimpleAdapter(UserShowPlaceEvaluationsActivity.this, evaluationsList, R.layout.evaluations_list, new String[]{
    ...
    public void onBackPressed() {
        ...
        Intent in = new Intent(UserShowPlaceEvaluationsActivity.this, UserShowPlaceMenuActivity.class);
