...
public class UserShowPlaceMySuggestionsActivity extends Activity {
    ...
    private static String url_suggestions = "https://yourvoice123.000webhostapp.com/user_show_place_my_suggestions.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_show_place_suggestions);
    ...
    class LoadAllSuggestions extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UserShowPlaceMySuggestionsActivity.this);
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(UserShowPlaceMySuggestionsActivity.this, message, Toast.LENGTH_LONG).show();

            // make list adapter to fill the suggestion list
            ListAdapter adapter = new SimpleAdapter(UserShowPlaceMySuggestionsActivity.this, suggestionsList, R.layout.suggestions_list, new String[]{
                    TAG_SUGGESTION_TITLE, TAG_SUGGESTION_CONTENT, TAG_SUGGESTION_DATE, TAG_SUGGESTION_ID}, new int[]{
                    R.id.suggestion_title, R.id.suggestion_content, R.id.suggestion_date, R.id.suggestion_id}
            );
    ...
    public void onBackPressed() {
        ...
        Intent in = new Intent(UserShowPlaceMySuggestionsActivity.this, UserShowPlaceMenuActivity.class);
