...
public class UserShowPlaceSuggestionsActivity extends Activity {
    ...
    class LoadAllSuggestions extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UserShowPlaceSuggestionsActivity.this);
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(UserShowPlaceSuggestionsActivity.this, message, Toast.LENGTH_LONG).show();

            // make list adapter to fill the suggestion list
            ListAdapter adapter = new SimpleAdapter(UserShowPlaceSuggestionsActivity.this, suggestionsList, R.layout.suggestions_list, new String[]{
    ...
    public void onBackPressed() {
        ...
        Intent in = new Intent(UserShowPlaceSuggestionsActivity.this, UserShowPlaceMenuActivity.class);
