...
public class EmployeeShowPlaceCompliantsActivity extends Activity {
    ...
    private static String url_compliants = "https://yourvoice123.000webhostapp.com/employee_show_compliants.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_show_compliants);
    ...
    class LoadAllCompliants extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeShowPlaceCompliantsActivity.this);
        ...
        protected void onPostExecute(String message) {
            ...
            adapter = new CompliantAdapter(EmployeeShowPlaceCompliantsActivity.this, R.layout.row, compliantsList);
            ...
            compliant_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    // compliant details
                    Intent compliant_detail = new Intent(EmployeeShowPlaceCompliantsActivity.this, EmployeeShowPlaceCompliantActivity.class);
