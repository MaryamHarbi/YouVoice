...
public class UserShowPlaceMyEvaluationsActivity extends Activity {
    ...
    private static String url_evaluations = "https://yourvoice123.000webhostapp.com/user_show_place_my_evaluations.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_show_place_evaluations);
    ...
    class LoadAllEvaluations extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UserShowPlaceMyEvaluationsActivity.this);
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(UserShowPlaceMyEvaluationsActivity.this, message, Toast.LENGTH_LONG).show();

            // make list adapter to fill the evaluation list
            ListAdapter adapter = new SimpleAdapter(UserShowPlaceMyEvaluationsActivity.this, evaluationsList, R.layout.evaluations_list, new String[]{
                    TAG_EVALUATION_TITLE, TAG_EVALUATION_NOTES, TAG_EVALUATION_RESULT, TAG_EVALUATION_DATE, TAG_EVALUATION_ID}, new int[]{
                    R.id.evaluation_title, R.id.evaluation_notes, R.id.evaluation_result, R.id.evaluation_date, R.id.evaluation_id}
            );
    ...
    public void onBackPressed() {
        ...
        Intent in = new Intent(UserShowPlaceMyEvaluationsActivity.this, UserShowPlaceMenuActivity.class);
